...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47138)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/loading.tsx"],
    ...
    const pages = ["/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/page.tsx"];
    ...
    const originalPathname = "/(dashboard)/[storeId]/(routes)/sizes/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 31815))
...
__webpack_require__.d(__webpack_exports__, {
  SizesClient: () => (/* binding */ SizesClient)
});
...
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/sizes/components/cell-action.tsx
...
const CellAction = ({ data  })=>{
    ...
    const onConfirm = async ()=>{
        try {
            setLoading(true);
            await axios/* default */.Z.delete(`/api/${params.storeId}/sizes/${data.id}`);
            dist/* toast */.Am.success("Size deleted.");
            router.refresh();
        } catch (error) {
            dist/* toast */.Am.error("Make sure you removed all products using this size first.");
        } finally{
            setOpen(false);
            setLoading(false);
        }
    ...
    const onCopy = (id)=>{
        ...
        dist/* toast */.Am.success("Size ID copied to clipboard.");
    };
...
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/sizes/components/columns.tsx
...
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/sizes/components/client.tsx
/* __next_internal_client_entry_do_not_use__ SizesClient auto */ 
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/components/client.tsx`)
...
const e0 = proxy["SizesClient"];

;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/sizes/page.tsx




const SizesPage = async ({ params  })=>{
    const sizes = await prismadb/* default */.Z.size.findMany({
        where: {
...
/* harmony default export */ const page = (SizesPage);
...
var __webpack_exports__ = __webpack_require__.X(0, [4359,6569,188,7036,5054,6190,8875,2656,9708,1787,9295,2239,2630,4116,7018,184], () => (__webpack_exec__(25408)));
