...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87971)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/billboards/page.tsx"],
          
        }]
      },
        {
          'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 33898)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/billboards/loading.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/loading.tsx"],
    ...
    const pages = ["/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/billboards/page.tsx"];
    ...
    const originalPathname = "/(dashboard)/[storeId]/(routes)/billboards/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 72994))
...
__webpack_require__.d(__webpack_exports__, {
  BillboardClient: () => (/* binding */ BillboardClient)
});
...
// EXTERNAL MODULE: ./components/ui/data-table.tsx + 1 modules
var data_table = __webpack_require__(32630);
// EXTERNAL MODULE: ./components/ui/heading.tsx
var heading = __webpack_require__(44849);
// EXTERNAL MODULE: ./components/ui/separator.tsx
var separator = __webpack_require__(98061);
// EXTERNAL MODULE: ./components/ui/api-list.tsx
var api_list = __webpack_require__(97018);
...
// EXTERNAL MODULE: ./components/modals/alert-modal.tsx
var alert_modal = __webpack_require__(63274);
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/billboards/components/cell-action.tsx
/* __next_internal_client_entry_do_not_use__ CellAction auto */ 
...
const CellAction = ({ data  })=>{
    ...
    // the delete fn is same as the billboard-form delete function
    const onConfirm = async ()=>{
        try {
            setLoading(true);
            await axios/* default */.Z.delete(`/api/${params.storeId}/billboards/${data.id}`); //here the endpt is data.id not the billboard.id
            dist/* toast */.Am.success("Billboard deleted.");
            router.refresh();
        } catch (error) {
            dist/* toast */.Am.error("Make sure you removed all categories using this billboard first.");
        } finally{
            setOpen(false);
            setLoading(false);
        }
    };
    // copy the billboard id (in the table cell)
    const onCopy = (id)=>{
        navigator.clipboard.writeText(id);
        dist/* toast */.Am.success("Billboard ID copied to clipboard.");
    };
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx(dropdown_menu/* DropdownMenuTrigger */.$F, {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)(ui_button/* Button */.z, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ jsx_runtime_.jsx(lucide_react/* MoreHorizontal */.yFf, {
                                    className: "h-4 w-4"
                                })
                            ]
                        })
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)(dropdown_menu/* DropdownMenuContent */.AW, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)(dropdown_menu/* DropdownMenuItem */.Xi, {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx(lucide_react/* Edit */.I8b, {
                                        className: "mr-2 h-4 w-4"
                                    }),
                                    " Update"
                                ]
...
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/billboards/components/columns.tsx
...
const columns = [
    ...
    {
        id: "actions",
        cell: ({ row  })=>/*#__PURE__*/ jsx_runtime_.jsx(CellAction, {
                data: row.original
            }) // this is how we access the original obj(billboard) that this cell is working with
    }
];

;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/billboards/components/client.tsx
/* __next_internal_client_entry_do_not_use__ BillboardClient auto */ 
...
const BillboardClient = ({ data  })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(data_table/* DataTable */.w, {
                searchKey: "label",
                columns: columns,
                data: data
            }),
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(separator.Separator, {}),
            /*#__PURE__*/ jsx_runtime_.jsx(api_list/* ApiList */.L, {
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/billboards/components/client.tsx`)
...
const e0 = proxy["BillboardClient"];

;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/billboards/page.tsx




// the billboard page with the table content
const BillboardsPage = async ({ params  })=>{
    const billboards = await prismadb/* default */.Z.billboard.findMany({
        ...
        orderBy: {
            createdAt: "desc" //ordered by the newest
        }
    });
    const formattedBillboards = billboards.map((item)=>({
            id: item.id,
            label: item.label,
            createdAt: (0,date_fns.format)(item.createdAt, "MMMM do, yyyy")
        }));
...
/* harmony default export */ const page = (BillboardsPage);
...
var __webpack_exports__ = __webpack_require__.X(0, [4359,6569,188,7036,5054,6190,8875,2656,9708,1787,9295,2239,2630,4116,7018,6597], () => (__webpack_exec__(3341)));
