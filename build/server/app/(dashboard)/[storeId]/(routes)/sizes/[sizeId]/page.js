...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 73681)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/[sizeId]/page.tsx"],
        ...
        {
          'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 84745)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/loading.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/loading.tsx"],
    ...
    const pages = ["/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/[sizeId]/page.tsx"];
    ...
    const originalPathname = "/(dashboard)/[storeId]/(routes)/sizes/[sizeId]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 41872))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SizeForm: () => (/* binding */ SizeForm)
/* harmony export */ });
...
/* __next_internal_client_entry_do_not_use__ SizeForm auto */ 
...
const formSchema = zod__WEBPACK_IMPORTED_MODULE_10__/* .object */ .Ry({
    name: zod__WEBPACK_IMPORTED_MODULE_10__/* .string */ .Z_().min(1),
    value: zod__WEBPACK_IMPORTED_MODULE_10__/* .string */ .Z_().min(1)
});
const SizeForm = ({ initialData  })=>{
    ...
    const onSubmit = async (data)=>{
        try {
            setLoading(true);
            if (initialData) {
                await axios__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z.patch(`/api/${params.storeId}/sizes/${params.sizeId}`, data);
            } else {
                await axios__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z.post(`/api/${params.storeId}/sizes`, data);
            }
            router.refresh();
    ...
    const onDelete = async ()=>{
        try {
            setLoading(true);
            await axios__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z.delete(`/api/${params.storeId}/sizes/${params.sizeId}`);
            router.refresh();
            router.push(`/${params.storeId}/sizes`);
            react_hot_toast__WEBPACK_IMPORTED_MODULE_2__/* .toast */ .Am.success("Size deleted.");
        } catch (error) {
            react_hot_toast__WEBPACK_IMPORTED_MODULE_2__/* .toast */ .Am.error("Make sure you removed all products using this size first.");
        } finally{
            setLoading(false);
            setOpen(false);
        }
...
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/sizes/[sizeId]/components/size-form.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/sizes/[sizeId]/components/size-form.tsx`)
...
const e0 = proxy["SizeForm"];

;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/sizes/[sizeId]/page.tsx
...
/* harmony default export */ const page = (SizePage);
...
var __webpack_exports__ = __webpack_require__.X(0, [4359,6569,188,7036,5054,6190,8875,2656,1787,9295,2239,184], () => (__webpack_exec__(10639)));
