...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4238)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/colors/[colorId]/page.tsx"],
        ...
        {
          'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 50110)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/colors/loading.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 24521)), "/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/loading.tsx"],
    ...
    const pages = ["/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/colors/[colorId]/page.tsx"];
    ...
    const originalPathname = "/(dashboard)/[storeId]/(routes)/colors/[colorId]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 77723))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ColorForm: () => (/* binding */ ColorForm)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(17123);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(40248);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(89048);
...
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(64660);
...
/* __next_internal_client_entry_do_not_use__ ColorForm auto */ 
...
const formSchema = zod__WEBPACK_IMPORTED_MODULE_10__/* .object */ .Ry({
    name: zod__WEBPACK_IMPORTED_MODULE_10__/* .string */ .Z_().min(2),
    value: zod__WEBPACK_IMPORTED_MODULE_10__/* .string */ .Z_().min(4).max(9).regex(/^#/, {
...
const ColorForm = ({ initialData  })=>{
    ...
    const form = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_11__/* .useForm */ .cI)({
        resolver: (0,_hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_12__/* .zodResolver */ .F)(formSchema),
    ...
    const onSubmit = async (data)=>{
        try {
            setLoading(true);
            if (initialData) {
                await axios__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z.patch(`/api/${params.storeId}/colors/${params.colorId}`, data);
            } else {
                await axios__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z.post(`/api/${params.storeId}/colors`, data);
            }
            router.refresh();
    ...
    const onDelete = async ()=>{
        try {
            setLoading(true);
            await axios__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z.delete(`/api/${params.storeId}/colors/${params.colorId}`);
            router.refresh();
            router.push(`/${params.storeId}/colors`);
            react_hot_toast__WEBPACK_IMPORTED_MODULE_2__/* .toast */ .Am.success("Color deleted.");
        } catch (error) {
            react_hot_toast__WEBPACK_IMPORTED_MODULE_2__/* .toast */ .Am.error("Make sure you removed all products using this color first.");
        } finally{
            setLoading(false);
            setOpen(false);
        }
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    ...
                    initialData && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_button__WEBPACK_IMPORTED_MODULE_5__/* .Button */ .z, {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(lucide_react__WEBPACK_IMPORTED_MODULE_14__/* .Trash */ .rFk, {
                            className: "h-4 w-4"
                        })
                    })
                ]
...
;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/colors/[colorId]/components/color-form.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/Users/nareshxo/Desktop/Macbook pro/Workplace/Next/Admin-Store/ecommerce-admin/app/(dashboard)/[storeId]/(routes)/colors/[colorId]/components/color-form.tsx`)
...
const e0 = proxy["ColorForm"];

;// CONCATENATED MODULE: ./app/(dashboard)/[storeId]/(routes)/colors/[colorId]/page.tsx



const ColorPage = async ({ params  })=>{
    const color = await prismadb/* default */.Z.color.findUnique({
        where: {
            id: params.colorId
        }
    });
...
/* harmony default export */ const page = (ColorPage);
...
var __webpack_exports__ = __webpack_require__.X(0, [4359,6569,188,7036,5054,6190,8875,2656,1787,9295,2239,1895], () => (__webpack_exec__(85359)));
